...
export default class CarveCardBuddies extends Component {
    constructor(props) {
        super(props);
        this.state = {
            carve_id: 0,
    ...
    componentWillMount() {
        axios.get(`http://localhost:8000/users/${localStorage.getItem('userId')}/follows/buddies/carves`)
            .then(res => {
                console.log("results bud carve: ", res.data.results[0]);
            ...
            carveList = this.state.carveInfo.map((carve, index) => {
                ...
                return (
                    ...
                    <ListGroup.Item key={index} style={{
                        ...
                        paddingRight: '0px', paddingLeft: '0px', paddingTop: '0px', paddingBottom: '10px'
                    }}>
                        ...
                        <Card style={{width: '100%', backgroundColor: [color]}}>
                            ...
                            <Card.Body>
                                ...
                                <Row style={{paddingTop: "5%", bordered: "5px solid black"}}>
                                    ...
                                    <Col>
                                        <box style={{color: "red", paddingTop: "10px"}}><i
                                            className="fa fa-thumbs-o-down text-danger"/> Dislikes: {dlik}</box>
                                    </Col>
                                    <Col>
                                        <box style={{color: "blue", paddingTop: "10px"}}><i
                                            className="fa fa-hand-rock-o " style={{color: "blue"}}/> Likes: {lik}</box>
                                    </Col>
                                </Row>
                            </Card.Body>
                                ...
                                <Row>
                                    <Col>
                                        <Row style={{width: "100%"}}> <Form inline style={{justify: "left"}}>
                                            <CustomFormGroup value={val} type="integer" placeholder="Add Comment"
                                                             className=" mr-sm-2" controlId="comment"
