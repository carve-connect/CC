    ...
    render() {
        ...
        if (this.state.venueInfoLength > 0) {
            ...
            if (!venueLoading) {
                ...
                if (followsVenue) {
                    followButton =
                        <Button style={{margin: '5px'}} variant="info" onClick={this.unFollowVenue}>Unfollow</Button>;
                } else {
                    // We do not follow the venue currently, offer them the option to follow it
                    followButton =
                        <Button style={{margin: '5px'}} variant="info" onClick={this.followVenue}>Follow</Button>;
                }
            } else {
