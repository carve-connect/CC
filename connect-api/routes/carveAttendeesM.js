...
router.delete('/', (req,res) => {
    ...
    deleteCarveAttend(delete_carve_attendeess);
});
...
router.put('/:carve_attendeesId', (req,res) => {
    ...
    updateCarveAttend(update_carve_attendees, carve_attendeesId);
});
...
router.delete('/:carve_attendeesId', (req,res) => {
    ...
    deleteCarveAttend(delete_carve_attendeess, carve_attendeesId);
});

function deleteCarveAttend(delete_carve_attendeess, carve_attendeesId){
    if(carve_attendeesId == undefined){
...
function updateCarveAttend(update_carve_attendees, carve_attendeesId){
