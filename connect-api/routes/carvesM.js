...
router.put('/:carveId', (req,res) => {
    ...
    updateCarves(update_carve, carveId);
});
...
router.delete('/:carveId', (req,res) => {
    ...
    // Execute the query to delete from the database
    deleteCarves(delete_carves, carveId);
});
...
function deleteCarves(delete_carves, carveId){
...
function updateCarves(update_carve, carveId){
