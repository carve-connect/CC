...
router.put('/', (req,res) => {
	...
	// Execute the query to insert into the database
	updateFollower(new_followerUser);
});
...
router.put('/', (req,res) => {
	...
	// Execute the query to insert into the database
	updateFollower(new_followerVenue);
});
...
router.put('/', (req,res) => {
	...
	// Execute the query to insert into the database
	updateFollower(new_followerBuddy);
});
...
router.put('/:followId', (req,res) => {
	...
	updateSpecificFollower(update_follow, followId);
});
...
router.delete('/:followId', (req,res) => {
	...
	// Execute the delete query
	deleteFollower(delete_follows, followId);
});

function deleteFollower(delete_follows, followId){
...
function updateFollower(new_follow){
...
function updateSpecificFollower(update_follow, followId){
